...
public class ProducerRepository {
    ...
    private static CallableStatement callableStatementFindByName(Connection conn, String name) throws SQLException {
        String sql = "CALL `anime_store`.`sp_ger_producer_by_name`(?);";
    ...
    public static List<Producer> findByNameAndUpdateToUpperCase(String name) {
        ...
        try (Connection conn = ConnectionFactory.getConnection();
            ...
            log.error("Error while trying to find producers by name and update to uppercase", e);
        }
        return producers;
    }
    ...
    public static List<Producer> findByNameAndInsertWhenNotFound(String name) {
        ...
        try (Connection conn = ConnectionFactory.getConnection();
            ...
            log.error("Error while trying to find producers by name and insert", e);
        }
        return producers;
    }
    ...
    public static void findByNameAndDelete(String name) {
        ...
        try (Connection conn = ConnectionFactory.getConnection();
             ...
             ResultSet rs = stmt.executeQuery(sql)) {
            while (rs.next()) {
                log.info("Delenting '{}'", rs.getString("name"));
                rs.deleteRow();
            }
        } catch (SQLException e) {
            log.error("Error while trying to find producers by name and delete", e);
        }
    }
