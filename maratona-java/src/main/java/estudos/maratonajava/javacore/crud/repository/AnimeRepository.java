...
import estudos.maratonajava.javacore.crud.dominio.Anime;
...
public class AnimeRepository {
    ...
    public static void delete(int id) {
        try (Connection conn = ConnectionFactory.getConnection();
            ...
            log.error("Error while trying to delete animes '{}'", id, e);
        }
    }
    ...
    public static void save(Anime anime) {
        ...
        try (Connection conn = ConnectionFactory.getConnection();
             PreparedStatement ps = createPrepateStatementSave(conn, anime)) {
            ps.execute();
        } catch (SQLException e) {
    ...
    private static PreparedStatement createPrepateStatementSave(Connection conn, Anime anime) throws SQLException {
